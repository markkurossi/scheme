...
var typePredicates = map[string]*types.Type{
	...
	"file-exists?":        types.String,
	"file-directory?":     types.String,
	"file-regular?":       types.String,
	"file-symbolic-link?": types.String,
	"input-port?":         types.Port,
	"output-port?":        types.Port,
	"char-alphabetic?":    types.Character,
	"char-numeric?":       types.Character,
	"char-whitespace?":    types.Character,
	"char-upper-case?":    types.Character,
	"char-lower-case?":    types.Character,
	"char-title-case?":    types.Character,
	"string?":             types.String,
	"symbol?":             types.Symbol,
	"vector?":             types.Vector,
}
